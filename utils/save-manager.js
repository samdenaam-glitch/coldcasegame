/* ====== SAVE MANAGER ====== */
/* Enhanced Save/Load System for Cold Case Files */
...
const SaveManager = {
    ...
    createEmptySave(slot) {
        ...
        this.saveToSlot(slot, emptySave);
        return emptySave;
    },
    
    // Save current game to slot
    saveGame(gameState, slot = this.currentSlot) {
        const saveData = {
            version: this.version,
            slot: slot,
            createdAt: Date.now(),
